...
>
> Diferente dos [critérios de aceite](12-criterios-de-aceite.md), que medem o produto pronto,
...
→ Falhou? [Etapa 8](10-etapa-8-icone-splash-e-versao.md) · [Módulo 16, aula 5](../../modulos/16-build-ios/05-icone-splash-versao-infoplist.md)
...
Medidos nos [critérios de aceite](12-criterios-de-aceite.md), seções RNF01–RNF09 e RNF14.
...
> 🍎 Sem Mac, o caminho é o [desafio P03-D08](13-desafios.md#p03-d08) — o pipeline de CI que gera
...
→ [Módulo 17](../../modulos/17-publicacao-e-proximos-passos/README.md)
...
| Os desafios do projeto | [13-desafios.md](13-desafios.md) |
| Escolher o que estudar depois | [Módulo 17, aula 6](../../modulos/17-publicacao-e-proximos-passos/06-proximos-passos.md) |
...
|---|---|---|
| [Desafios](13-desafios.md) | [README](README.md) | [Módulo 17](../../modulos/17-publicacao-e-proximos-passos/README.md) |
