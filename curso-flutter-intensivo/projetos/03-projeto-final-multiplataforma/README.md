...
| 8 | [Ícone, splash e versão](10-etapa-8-icone-splash-e-versao.md) | Identidade e preparo de build | 1,5 h | M15, M16 |
| 9 | [PWA e publicação](11-etapa-9-pwa-e-publicacao.md) | **Banco web, manifest, deploy — o Foco no ar** | 2 h | **M14** |
...
| [03 a 11 — As nove etapas](03-etapa-1-fundacao.md) | A construção guiada | Uma por vez, na ordem |
| [12 — Critérios de aceite](12-criterios-de-aceite.md) | Como saber que está pronto, com o gesto exato | Ao fim de cada etapa e no final |
| [13 — Desafios](13-desafios.md) | 10 extensões opcionais | Depois de o app passar no aceite |
| [14 — Checklist](14-checklist.md) | Verificação por etapa, com onde revisar | Durante, sempre que travar |
...
- **Durante a construção** → [14-checklist.md](14-checklist.md), que acompanha etapa por etapa e
  aponta onde revisar quando algo falha.
- **Ao declarar pronto** → [12-criterios-de-aceite.md](12-criterios-de-aceite.md), que mede o
