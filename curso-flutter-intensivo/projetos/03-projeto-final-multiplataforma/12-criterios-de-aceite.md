...
> macOS** (módulo 17, aula 4); nesse caso o critério vira "o job de iOS passou no CI".
...
Faltou um? O app não está pronto. Volte ao [checklist](14-checklist.md), que diz **onde** revisar.

---

| ⬅️ Anterior | 🏠 Projeto | ➡️ Próximo |
|---|---|---|
| [Etapa 8 — Ícone, splash e versão](10-etapa-8-icone-splash-e-versao.md) | [README](README.md) | [Desafios](13-desafios.md) |
