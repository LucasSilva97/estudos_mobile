# Avaliação — Módulo 16: Build e distribuição iOS
...
|---|---|---|
| Por que não dá para compilar no Windows | [Aula 01](../modulos/16-build-ios/01-por-que-exige-macos.md) | E01 |
| Xcode, SPM e CocoaPods | [Aula 02](../modulos/16-build-ios/02-xcode-e-cocoapods.md) | E02 |
| Bundle ID, workspace e Deployment Target | [Aula 04](../modulos/16-build-ios/04-bundle-id-e-xcode.md) | E03 |
| Ícone, versão e `Info.plist` | [Aula 05](../modulos/16-build-ios/05-icone-splash-versao-infoplist.md) | E04 e E05 |
| Conta Apple e seus limites | [Aula 06](../modulos/16-build-ios/06-conta-apple-gratuita-x-paga.md) | E06 |
| Certificados e provisioning | [Aula 07](../modulos/16-build-ios/07-certificados-e-provisioning.md) | E07 |
| Archive, IPA e TestFlight | [Aulas 08 e 09](../modulos/16-build-ios/08-build-ipa-e-archive.md) | E08 |
