# Gabarito — Módulo 16: Publicação e próximos passos

> Compare depois de resolver os [exercícios](../exercicios/16-publicacao-e-proximos-passos.md).
...
- [ ] Publicar na faixa interna (módulo 14)
  ...
  android:
    ...
    steps:
      ...
      - uses: subosito/flutter-action@v2
        with: { flutter-version: '${{ env.FLUTTER_VERSION }}', cache: true }
      - run: flutter pub get
      - name: Restaurar o keystore   # mesmo passo de M16-E09
        env:
          KEYSTORE_B64: ${{ secrets.ANDROID_KEYSTORE_B64 }}
