...
- [Módulo 15, aula 3 — Ícone](../15-build-android/03-icone.md) e
  [aula 4 — Splash screen](../15-build-android/04-splash-screen.md) — o mesmo PNG 1024×1024 serve
  para as duas plataformas.
- [Módulo 15, aula 5 — Permissões Android](../15-build-android/05-permissoes-android.md) — o
