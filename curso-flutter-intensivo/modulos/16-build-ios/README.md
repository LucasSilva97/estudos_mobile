...
> **Posição no plano:** Dia 30 do ritmo intensivo de 30 dias
...
| 3 | Gerar **APK e AAB** assinados de verdade e instalar no Android | [Módulo 15](../15-build-android/README.md) |
...
- **Obrigatório:** ter concluído o
  ...
  O módulo 15 ensina os conceitos que este módulo reaproveita: build de release, identidade do
...
|---|---|---|
| Exercícios do módulo | [exercicios/16-build-ios.md](../../exercicios/16-build-ios.md) | Depois de terminar as 10 aulas |
| Gabaritos comentados | [gabaritos/16-build-ios.md](../../gabaritos/16-build-ios.md) | Só **depois** de tentar de verdade |
| Avaliação do módulo | [avaliacoes/modulo-16-build-ios.md](../../avaliacoes/modulo-16-build-ios.md) | Ao final, para liberar o Módulo 17 |
...
- [ ] Concluí ao menos **8 exercícios obrigatórios** de
      [exercicios/16-build-ios.md](../../exercicios/16-build-ios.md).
- [ ] Acertei **7 ou mais** das 10 questões de
      [avaliacoes/modulo-16-build-ios.md](../../avaliacoes/modulo-16-build-ios.md).

Quando todos os itens estiverem marcados, siga para o
[Módulo 17 — Publicação e Próximos Passos](../17-publicacao-e-proximos-passos/README.md).

---

| ⬅️ Anterior | 🏠 Curso | ➡️ Próximo |
|---|---|---|
| [Módulo 15 — Build e Distribuição Android](../15-build-android/README.md) | [README do curso](../../README.md) | [Aula 1 — Por que o iOS exige macOS](01-por-que-exige-macos.md) |
