...
> **Módulo:** 16 - Build e Distribuição iOS · **Tempo estimado:** 35 min · **Nível:** Avançado
...
- [Módulo 15, aula 2 — Identidade do app](../15-build-android/02-identidade-do-app.md) — o
...
> antigos nunca recebem a atualização. É a mesma regra do `applicationId` do Android (módulo 15,
...
if (Test-Path $gradle) {
    ...
    if ($appId -and $appId -ne $Novo) {
        ...
        Write-Host '   Módulo 15, aula 2.' -ForegroundColor Gray
    } else {
