...
> **Módulo:** 16 - Build e Distribuição iOS · **Tempo estimado:** 40 min · **Nível:** Avançado
...
- [Módulo 15, aula 10 — Diagnóstico de build](../15-build-android/10-diagnostico-de-build.md) — o
...
Depois responda: comparando com o `DEBUG-ANDROID.md` do módulo 15, qual plataforma consumiu mais
...
|---|---|---|
| [Aula 9 — Exportando o IPA e TestFlight](09-exportando-ipa-e-testflight.md) | [README](README.md) | [Módulo 17 — Publicação e próximos passos](../17-publicacao-e-proximos-passos/README.md) |
