...
> **Módulo:** 16 - Publicação e próximos passos · **Tempo estimado:** 40 min · **Nível:** Avançado
...
- [Módulo 14, aula 8 — Gerando APK e AAB](../14-build-android/08-gerando-apk-e-aab.md) — o
  `versionCode` que precisa crescer.
- [Módulo 15, aula 9 — TestFlight](../15-build-ios/09-exportando-ipa-e-testflight.md) — o
...
> interno (módulo 15, aula 9) importa tanto: **no iOS, o erro que escapa custa dias.**
...
```powershell
.\tool\release.ps1 -Formato aab          # módulo 14, aula 8
```

```bash
./ferramentas/build-ios.sh               # módulo 15, aula 8
```
...
#
# Não faz o build — isso é tool/release.ps1 (módulo 14, aula 8).
...
Write-Host '  2. .\tool\release.ps1             (Android — módulo 14, aula 8)'
Write-Host '  3. ./ferramentas/build-ios.sh     (iOS — módulo 15, aula 8)'
...
- O checklist pré-release, unindo os módulos 14 e 15.
