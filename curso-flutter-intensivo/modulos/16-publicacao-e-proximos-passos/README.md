...
> **Tempo estimado total:** 250 min (4 h 10) · **Nível:** Intermediário → Avançado · **Posição no plano:** Dia 29 (fim) e Dia 30 do ritmo intensivo de 30 dias

Este é o **último módulo de conteúdo do curso**. Nos módulos 14 e 15 você aprendeu a transformar
...
- [Módulo 15 — Build iOS](../15-build-ios/README.md) concluído. Você precisa entender por que o
  build iOS exige macOS antes de discutir a App Store.
- [Módulo 14 — Build Android](../14-build-android/README.md) concluído, com um **`.aab` assinado
...
**Total: 250 min.** No ritmo intensivo recomendado, este módulo fecha o **Dia 29** e entra no
**Dia 30**. O cronograma completo está em [01-plano-intensivo.md](../../01-plano-intensivo.md).
...
|---|---|---|
| Exercícios do módulo | [exercicios/16-publicacao-e-proximos-passos.md](../../exercicios/16-publicacao-e-proximos-passos.md) | Depois de terminar as 6 aulas |
| Gabaritos comentados | [gabaritos/16-publicacao-e-proximos-passos.md](../../gabaritos/16-publicacao-e-proximos-passos.md) | Só **depois** de tentar de verdade |
| Avaliação do módulo | [avaliacoes/modulo-16-publicacao-e-proximos-passos.md](../../avaliacoes/modulo-16-publicacao-e-proximos-passos.md) | Ao final, para fechar o curso |
...
diagnóstico em [14-build-android/10-diagnostico-de-build.md](../14-build-android/10-diagnostico-de-build.md).
...
- [ ] Concluí ao menos **8 exercícios obrigatórios** de
      [exercicios/16-publicacao-e-proximos-passos.md](../../exercicios/16-publicacao-e-proximos-passos.md).
- [ ] Acertei **7 ou mais** das 10 questões de
      [avaliacoes/modulo-16-publicacao-e-proximos-passos.md](../../avaliacoes/modulo-16-publicacao-e-proximos-passos.md).
...
|---|---|---|
| [Módulo 15 — Build iOS](../15-build-ios/README.md) | [README do curso](../../README.md) | [Aula 1 — Google Play](01-google-play.md) |
