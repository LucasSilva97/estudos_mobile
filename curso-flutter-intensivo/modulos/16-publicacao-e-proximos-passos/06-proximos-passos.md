...
| Flutter Web e desktop | Outras plataformas |
...
- [ ] Publicar na faixa interna do Android (módulo 14)
...
- [ ] Monitoramento completo (módulo 16, aula 5)
...
- [ ] CI configurado (módulo 16, aula 4)
...
- Isso é **mais do que a maioria das vagas júnior exige** — e, em publicação e CI, mais do que muita
  pessoa pleno domina.
- O curso **não cobriu**: animações avançadas, i18n, backend, deep links, pagamentos, web. Nenhum
  deles é pré-requisito para publicar um app bom.
