...
> **Módulo:** 17 - Publicação e Próximos Passos · **Tempo estimado:** 45 min · **Nível:** Intermediário
...
- [Módulo 15 — Build Android](../15-build-android/README.md) concluído, com a **keystore de upload**
  criada em [06-keystore.md](../15-build-android/06-keystore.md) e a assinatura configurada em
  [07-assinatura-no-gradle.md](../15-build-android/07-assinatura-no-gradle.md).
- Um arquivo `build/app/outputs/bundle/release/app-release.aab` gerado conforme
  [08-gerando-apk-e-aab.md](../15-build-android/08-gerando-apk-e-aab.md).
- `applicationId = "br.com.estudos.foco"` já definido, conforme
  [02-identidade-do-app.md](../15-build-android/02-identidade-do-app.md).
...
> [15-build-android/03-icone.md](../15-build-android/03-icone.md)). O de 512×512 é um arquivo
...
[15-build-android/02-identidade-do-app.md](../15-build-android/02-identidade-do-app.md).
...
**Passo 3 — Tirar as capturas de tela.** Use o emulador Android criado no módulo 15 (`flutter run`
