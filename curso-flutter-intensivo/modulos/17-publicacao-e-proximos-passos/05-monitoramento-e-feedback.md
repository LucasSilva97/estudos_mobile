...
> **Módulo:** 17 - Publicação e próximos passos · **Tempo estimado:** 35 min · **Nível:** Avançado
...
> na abertura (módulo 15, aula 5), tela inicial vazia sem explicação, ou um crash no primeiro uso.
...
> relatado: é o ponto cego de todo crash reporting, e a razão de o teste interno (módulo 16, aula 9)
