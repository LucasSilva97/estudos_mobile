...
- [Módulo 16 — Build iOS](../16-build-ios/README.md) concluído, em especial
  [01-por-que-exige-macos.md](../16-build-ios/01-por-que-exige-macos.md),
  [06-conta-apple-gratuita-x-paga.md](../16-build-ios/06-conta-apple-gratuita-x-paga.md) e
  [09-exportando-ipa-e-testflight.md](../16-build-ios/09-exportando-ipa-e-testflight.md).
...
[16-build-ios/04-bundle-id-e-xcode.md](../16-build-ios/04-bundle-id-e-xcode.md).
...
Esse arquivo é exatamente um dos que o `flutter_launcher_icons` gerou para você no módulo 15 (veja
[15-build-android/03-icone.md](../15-build-android/03-icone.md)). Requisitos:
