...
> **Módulo:** 15 - Build e Distribuição iOS · **Tempo estimado:** 30 min · **Nível:** Fundamental
...
- [Módulo 14 — Build e Distribuição Android](../14-build-android/README.md) concluído. Você já
...
envia código, em vez de na sua máquina. O Módulo 16 trata disso em
[04-ci-cd-introdutorio.md](../16-publicacao-e-proximos-passos/04-ci-cd-introdutorio.md).
