...
> assunto do Módulo 16, aula 4. O roteiro desta aula é exatamente o que vai dentro desse CI.
...
São os símbolos do código **nativo** — o equivalente iOS do `mapping.txt` do R8 (módulo 14, aula 8).
...
#    com runner macOS (Módulo 16, aula 4).
#
