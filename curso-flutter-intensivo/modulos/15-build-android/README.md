...
> **Tempo estimado total:** 450 min (7 h 30) · **Nível:** Avançado · **Posição no plano:** Dia 29 do ritmo intensivo de 30 dias
...
> [Módulo 16 — Build e Distribuição iOS](../16-build-ios/README.md), e ele deixa claro o que exige
...
- Ter concluído o [Módulo 14 — Build Web (PWA)](../14-build-web-pwa/README.md). O Foco já deve
  estar **publicado como PWA** — este módulo acrescenta um canal, não substitui o primeiro.
...
**Dia 29**. O objetivo do dia é sair com **APK e AAB gerados e
...
|---|---|---|
| Exercícios do módulo | [exercicios/15-build-android.md](../../exercicios/15-build-android.md) | Depois de terminar as 10 aulas |
| Gabaritos comentados | [gabaritos/15-build-android.md](../../gabaritos/15-build-android.md) | Só **depois** de tentar de verdade |
| Avaliação do módulo | [avaliacoes/modulo-15-build-android.md](../../avaliacoes/modulo-15-build-android.md) | Ao final, para liberar o Módulo 16 |
...
git status
git add .
git commit -m "Ponto de partida antes do módulo 15 (build Android)"
```
...
- [ ] Concluí ao menos **8 exercícios obrigatórios** de
      [exercicios/15-build-android.md](../../exercicios/15-build-android.md).
- [ ] Acertei **7 ou mais** das 10 questões de
      [avaliacoes/modulo-15-build-android.md](../../avaliacoes/modulo-15-build-android.md).

Quando todos os itens estiverem marcados, siga para o
[Módulo 16 — Build e Distribuição iOS](../16-build-ios/README.md).

---

| ⬅️ Anterior | 🏠 Curso | ➡️ Próximo |
|---|---|---|
| [Módulo 14 — Build Web (PWA)](../14-build-web-pwa/README.md) | [README do curso](../../README.md) | [Aula 1 — Debug, profile e release](01-debug-profile-release.md) |
