...
> no `pubspec.yaml`, controla a versão nas duas plataformas.** O Módulo 15 volta a esse ponto pelo
> lado do iOS, em
> [05 — Ícone, splash, versão e Info.plist](../15-build-ios/05-icone-splash-versao-infoplist.md).
...
`MAIOR` em mudança que quebra compatibilidade. O módulo 16 detalha isso em
[03 — Versionamento e releases](../16-publicacao-e-proximos-passos/03-versionamento-e-releases.md).
...
> [15-build-ios/04-bundle-id-e-xcode.md](../15-build-ios/04-bundle-id-e-xcode.md). Use o **mesmo**
